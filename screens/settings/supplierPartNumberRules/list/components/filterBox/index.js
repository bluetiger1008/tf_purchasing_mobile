...
const FilterBox = ({
  ...
  const [supplier, setSupplier] = useState(defaultValues.supplierId)
  ...
  const onSubmitFilter = () => {
    onClose()
    onChangeFilter(supplier, partNumberClass, searchTerm)
  }
  return (
    <View style={styles.modalWrapper}>
      <View style={styles.content}>
        ...
        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>Supplier</Text>
